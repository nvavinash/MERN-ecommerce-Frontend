...
const CheckOut = () => {
    ...
    const addresses = [
      ...
      state: "Uttar Pradesh",
      phone: "8299177208",
      email:"avinash.fortax@gmail.com"
    },
    {
      name: "Babu Nagvanshi",
      street: "kandivali west",
      city: "Mumbai",
      pinCode: "400004",
      state: "Maharastra",
      phone: "9029378333"
  ...
  return (
    ...
    <form className="bg-white mt-20 p-10" >
            ...
            <fieldset>
              ...
              <div className="mt-4 space-y-6">
                <div className="flex items-center gap-x-3">
                  ...
                  <p className="truncate text-xs leading-5 text-gray-500">Sorry Your Order is not eligible for Cash Payment</p>
                </div>
                <div className="flex items-center gap-x-3">
                  <input
                    id="card"
